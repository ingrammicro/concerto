...
func GetTemplateListMocked(t *testing.T, templatesIn *[]types.Template) *[]types.Template {
	...
	// call service
	cs.On("Get", "/v2/blueprint/templates").Return(dIn, 200, nil)
...
func GetTemplateListFailErrMocked(t *testing.T, templatesIn *[]types.Template) *[]types.Template {
	...
	// call service
	cs.On("Get", "/v2/blueprint/templates").Return(dIn, 200, fmt.Errorf("Mocked error"))
	templatesOut, err := ds.GetTemplateList()
...
func GetTemplateListFailStatusMocked(t *testing.T, templatesIn *[]types.Template) *[]types.Template {
	...
	// call service
	cs.On("Get", "/v2/blueprint/templates").Return(dIn, 499, nil)
	templatesOut, err := ds.GetTemplateList()
...
func GetTemplateMocked(t *testing.T, template *types.Template) *types.Template {
	...
	// call service
	cs.On("Get", fmt.Sprintf("/v2/blueprint/templates/%s", template.ID)).Return(dIn, 200, nil)
...
func GetTemplateFailErrMocked(t *testing.T, template *types.Template) *types.Template {
	...
	// call service
	cs.On("Get", fmt.Sprintf("/v2/blueprint/templates/%s", template.ID)).Return(dIn, 200, fmt.Errorf("Mocked error"))
	templateOut, err := ds.GetTemplate(template.ID)
	assert.NotNil(err, "We are expecting an error")
...
func GetTemplateFailStatusMocked(t *testing.T, template *types.Template) *types.Template {
	...
	// call service
	cs.On("Get", fmt.Sprintf("/v2/blueprint/templates/%s", template.ID)).Return(dIn, 499, nil)
	templateOut, err := ds.GetTemplate(template.ID)
	assert.NotNil(err, "We are expecting an status code error")
	assert.Nil(templateOut, "Expecting nil output")
	assert.Contains(err.Error(), "499", "Error should contain http code 499")
...
func CreateTemplateMocked(t *testing.T, templateIn *types.Template) *types.Template {
	...
	// call service
	cs.On("Post", "/v2/blueprint/templates/", mapIn).Return(dOut, 200, nil)
...
func CreateTemplateFailErrMocked(t *testing.T, templateIn *types.Template) *types.Template {
	...
	// call service
	cs.On("Post", "/v2/blueprint/templates/", mapIn).Return(dOut, 200, fmt.Errorf("Mocked error"))
	templateOut, err := ds.CreateTemplate(mapIn)
	assert.NotNil(err, "We are expecting an error")
	assert.Nil(templateOut, "Expecting nil output")
	assert.Equal(err.Error(), "Mocked error", "Error should be 'Mocked error'")
...
func CreateTemplateFailStatusMocked(t *testing.T, templateIn *types.Template) *types.Template {
	...
	// call service
	cs.On("Post", "/v2/blueprint/templates/", mapIn).Return(dOut, 499, nil)
	templateOut, err := ds.CreateTemplate(mapIn)
	assert.NotNil(err, "We are expecting an status code error")
	assert.Nil(templateOut, "Expecting nil output")
	assert.Contains(err.Error(), "499", "Error should contain http code 499")
...
func UpdateTemplateMocked(t *testing.T, templateIn *types.Template) *types.Template {
	...
	// call service
	cs.On("Put", fmt.Sprintf("/v2/blueprint/templates/%s", templateIn.ID), mapIn).Return(dOut, 200, nil)
...
func UpdateTemplateFailErrMocked(t *testing.T, templateIn *types.Template) *types.Template {
	...
	// call service
	cs.On("Put", fmt.Sprintf("/v2/blueprint/templates/%s", templateIn.ID), mapIn).Return(dOut, 200, fmt.Errorf("Mocked error"))
	templateOut, err := ds.UpdateTemplate(mapIn, templateIn.ID)
	assert.NotNil(err, "We are expecting an error")
	assert.Nil(templateOut, "Expecting nil output")
	assert.Equal(err.Error(), "Mocked error", "Error should be 'Mocked error'")
...
func UpdateTemplateFailStatusMocked(t *testing.T, templateIn *types.Template) *types.Template {
	...
	// call service
	cs.On("Put", fmt.Sprintf("/v2/blueprint/templates/%s", templateIn.ID), mapIn).Return(dOut, 499, nil)
	templateOut, err := ds.UpdateTemplate(mapIn, templateIn.ID)
	assert.NotNil(err, "We are expecting an status code error")
	assert.Nil(templateOut, "Expecting nil output")
	assert.Contains(err.Error(), "499", "Error should contain http code 499")
...
func DeleteTemplateMocked(t *testing.T, templateIn *types.Template) {
	...
	// call service
	cs.On("Delete", fmt.Sprintf("/v2/blueprint/templates/%s", templateIn.ID)).Return(dIn, 200, nil)
...
func DeleteTemplateFailErrMocked(t *testing.T, templateIn *types.Template) {
	...
	// call service
	cs.On("Delete", fmt.Sprintf("/v2/blueprint/templates/%s", templateIn.ID)).Return(dIn, 200, fmt.Errorf("Mocked error"))
	err = ds.DeleteTemplate(templateIn.ID)
	assert.NotNil(err, "We are expecting an error")
	assert.Equal(err.Error(), "Mocked error", "Error should be 'Mocked error'")
...
func DeleteTemplateFailStatusMocked(t *testing.T, templateIn *types.Template) {
	...
	// call service
	cs.On("Delete", fmt.Sprintf("/v2/blueprint/templates/%s", templateIn.ID)).Return(dIn, 499, nil)
	err = ds.DeleteTemplate(templateIn.ID)
	assert.NotNil(err, "We are expecting an status code error")
	assert.Contains(err.Error(), "499", "Error should contain http code 499")
...
func GetTemplateScriptListMocked(t *testing.T, templateScriptsIn *[]types.TemplateScript, templateID string, scriptType string) *[]types.TemplateScript {
	...
	// call service
	cs.On("Get", fmt.Sprintf("/v2/blueprint/templates/%s/scripts?type=%s", templateID, scriptType)).Return(drsIn, 200, nil)
...
func GetTemplateScriptListFailErrMocked(t *testing.T, templateScriptsIn *[]types.TemplateScript, templateID string, scriptType string) *[]types.TemplateScript {
	...
	// call service
	cs.On("Get", fmt.Sprintf("/v2/blueprint/templates/%s/scripts?type=%s", templateID, scriptType)).Return(drsIn, 200, fmt.Errorf("Mocked error"))
	drsOut, err := ds.GetTemplateScriptList(templateID, scriptType)
	assert.NotNil(err, "We are expecting an error")
...
func GetTemplateScriptListFailStatusMocked(t *testing.T, templateScriptsIn *[]types.TemplateScript, templateID string, scriptType string) *[]types.TemplateScript {
	...
	// call service
	cs.On("Get", fmt.Sprintf("/v2/blueprint/templates/%s/scripts?type=%s", templateID, scriptType)).Return(drsIn, 499, nil)
	drsOut, err := ds.GetTemplateScriptList(templateID, scriptType)
	assert.NotNil(err, "We are expecting an status code error")
	assert.Nil(drsOut, "Expecting nil output")
	assert.Contains(err.Error(), "499", "Error should contain http code 499")
...
func GetTemplateScriptMocked(t *testing.T, dr *types.TemplateScript) *types.TemplateScript {
	...
	// call service
	cs.On("Get", fmt.Sprintf("/v2/blueprint/templates/%s/scripts/%s", dr.TemplateID, dr.ID)).Return(drIn, 200, nil)
...
func GetTemplateScriptFailErrMocked(t *testing.T, dr *types.TemplateScript) *types.TemplateScript {
	...
	// call service
	cs.On("Get", fmt.Sprintf("/v2/blueprint/templates/%s/scripts/%s", dr.TemplateID, dr.ID)).Return(drIn, 200, fmt.Errorf("Mocked error"))
	drOut, err := ds.GetTemplateScript(dr.TemplateID, dr.ID)
	assert.NotNil(err, "We are expecting an error")
...
func GetTemplateScriptFailStatusMocked(t *testing.T, dr *types.TemplateScript) *types.TemplateScript {
	...
	// call service
	cs.On("Get", fmt.Sprintf("/v2/blueprint/templates/%s/scripts/%s", dr.TemplateID, dr.ID)).Return(drIn, 499, nil)
	drOut, err := ds.GetTemplateScript(dr.TemplateID, dr.ID)
	assert.NotNil(err, "We are expecting an status code error")
	assert.Nil(drOut, "Expecting nil output")
	assert.Contains(err.Error(), "499", "Error should contain http code 499")
...
func CreateTemplateScriptMocked(t *testing.T, dr *types.TemplateScript) *types.TemplateScript {
	...
	// call service
	cs.On("Post", fmt.Sprintf("/v2/blueprint/templates/%s/scripts", dr.TemplateID), mapIn).Return(drIn, 200, nil)
...
func CreateTemplateScriptFailErrMocked(t *testing.T, dr *types.TemplateScript) *types.TemplateScript {
	...
	// call service
	cs.On("Post", fmt.Sprintf("/v2/blueprint/templates/%s/scripts", dr.TemplateID), mapIn).Return(drIn, 200, fmt.Errorf("Mocked error"))
	drOut, err := ds.CreateTemplateScript(mapIn, dr.TemplateID)
	assert.NotNil(err, "We are expecting an error")
	assert.Nil(drOut, "Expecting nil output")
	assert.Equal(err.Error(), "Mocked error", "Error should be 'Mocked error'")
...
func CreateTemplateScriptFailStatusMocked(t *testing.T, dr *types.TemplateScript) *types.TemplateScript {
	...
	// call service
	cs.On("Post", fmt.Sprintf("/v2/blueprint/templates/%s/scripts", dr.TemplateID), mapIn).Return(drIn, 499, nil)
	drOut, err := ds.CreateTemplateScript(mapIn, dr.TemplateID)
	assert.NotNil(err, "We are expecting an status code error")
	assert.Nil(drOut, "Expecting nil output")
	assert.Contains(err.Error(), "499", "Error should contain http code 499")
...
func UpdateTemplateScriptMocked(t *testing.T, dr *types.TemplateScript) *types.TemplateScript {
	...
	// call service
	cs.On("Put", fmt.Sprintf("/v2/blueprint/templates/%s/scripts/%s", dr.TemplateID, dr.ID), mapIn).Return(drIn, 200, nil)
...
func UpdateTemplateScriptFailErrMocked(t *testing.T, dr *types.TemplateScript) *types.TemplateScript {
	...
	// call service
	cs.On("Put", fmt.Sprintf("/v2/blueprint/templates/%s/scripts/%s", dr.TemplateID, dr.ID), mapIn).Return(drIn, 200, fmt.Errorf("Mocked error"))
	drOut, err := ds.UpdateTemplateScript(mapIn, dr.TemplateID, dr.ID)
	assert.NotNil(err, "We are expecting an error")
	assert.Nil(drOut, "Expecting nil output")
	assert.Equal(err.Error(), "Mocked error", "Error should be 'Mocked error'")
...
func UpdateTemplateScriptFailStatusMocked(t *testing.T, dr *types.TemplateScript) *types.TemplateScript {
	...
	// call service
	cs.On("Put", fmt.Sprintf("/v2/blueprint/templates/%s/scripts/%s", dr.TemplateID, dr.ID), mapIn).Return(drIn, 499, nil)
	drOut, err := ds.UpdateTemplateScript(mapIn, dr.TemplateID, dr.ID)
	assert.NotNil(err, "We are expecting an status code error")
	assert.Nil(drOut, "Expecting nil output")
	assert.Contains(err.Error(), "499", "Error should contain http code 499")
...
func ReorderTemplateScriptMocked(t *testing.T, tsOut *[]types.TemplateScript, templateID string, reorder []string) *[]types.TemplateScript {
	...
	// call service
	cs.On("Put", fmt.Sprintf("/v2/blueprint/templates/%s/scripts/reorder", templateID), &v).Return(tsOutJSON, 200, nil)
...
func ReorderTemplateScriptFailErrMocked(t *testing.T, tsOut *[]types.TemplateScript, templateID string, reorder []string) *[]types.TemplateScript {
	...
	// call service
	cs.On("Put", fmt.Sprintf("/v2/blueprint/templates/%s/scripts/reorder", templateID), &v).Return(tsOutJSON, 200, fmt.Errorf("Mocked error"))
	out, err := ds.ReorderTemplateScript(&v, templateID)
	assert.NotNil(err, "We are expecting an error")
...
func ReorderTemplateScriptFailStatusMocked(t *testing.T, tsOut *[]types.TemplateScript, templateID string, reorder []string) *[]types.TemplateScript {
	...
	// call service
	cs.On("Put", fmt.Sprintf("/v2/blueprint/templates/%s/scripts/reorder", templateID), &v).Return(tsOutJSON, 499, nil)
	out, err := ds.ReorderTemplateScript(&v, templateID)
	assert.NotNil(err, "We are expecting an status code error")
	assert.Nil(out, "Expecting nil output")
	assert.Contains(err.Error(), "499", "Error should contain http code 499")
...
func DeleteTemplateScriptMocked(t *testing.T, dr *types.TemplateScript) {
	...
	// call service
	cs.On("Delete", fmt.Sprintf("/v2/blueprint/templates/%s/scripts/%s", dr.TemplateID, dr.ID)).Return(drIn, 200, nil)
...
func DeleteTemplateScriptFailErrMocked(t *testing.T, dr *types.TemplateScript) {
	...
	// call service
	cs.On("Delete", fmt.Sprintf("/v2/blueprint/templates/%s/scripts/%s", dr.TemplateID, dr.ID)).Return(drIn, 200, fmt.Errorf("Mocked error"))
	err = ds.DeleteTemplateScript(dr.TemplateID, dr.ID)
	assert.NotNil(err, "We are expecting an error")
	assert.Equal(err.Error(), "Mocked error", "Error should be 'Mocked error'")
...
func DeleteTemplateScriptFailStatusMocked(t *testing.T, dr *types.TemplateScript) {
	...
	// call service
	cs.On("Delete", fmt.Sprintf("/v2/blueprint/templates/%s/scripts/%s", dr.TemplateID, dr.ID)).Return(drIn, 499, nil)
	err = ds.DeleteTemplateScript(dr.TemplateID, dr.ID)
	assert.NotNil(err, "We are expecting an status code error")
	assert.Contains(err.Error(), "499", "Error should contain http code 499")
}
...
func GetTemplateServerListMocked(t *testing.T, templateServersIn *[]types.TemplateServer, templateID string) *[]types.TemplateServer {
	...
	// call service
	cs.On("Get", fmt.Sprintf("/v2/blueprint/templates/%s/servers", templateID)).Return(drsIn, 200, nil)
...
func GetTemplateServerListFailErrMocked(t *testing.T, templateServersIn *[]types.TemplateServer, templateID string) *[]types.TemplateServer {
	...
	// call service
	cs.On("Get", fmt.Sprintf("/v2/blueprint/templates/%s/servers", templateID)).Return(drsIn, 200, fmt.Errorf("Mocked error"))
	drsOut, err := ds.GetTemplateServerList(templateID)
	assert.NotNil(err, "We are expecting an error")
	assert.Nil(drsOut, "Expecting nil output")
	assert.Equal(err.Error(), "Mocked error", "Error should be 'Mocked error'")
...
func GetTemplateServerListFailStatusMocked(t *testing.T, templateServersIn *[]types.TemplateServer, templateID string) *[]types.TemplateServer {
	...
	// call service
	cs.On("Get", fmt.Sprintf("/v2/blueprint/templates/%s/servers", templateID)).Return(drsIn, 499, nil)
	drsOut, err := ds.GetTemplateServerList(templateID)
	assert.NotNil(err, "We are expecting an status code error")
	assert.Nil(drsOut, "Expecting nil output")
	assert.Contains(err.Error(), "499", "Error should contain http code 499")
